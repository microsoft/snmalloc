...
namespace snmalloc
{
  ...
  template<
    ...
    bool TRACE = false,
    typename Policy = rankbalancetree::RedBlackPolicy<Rep, run_checks, TRACE>>
  ...
  public:
    ...
    {
      Policy::insert_path(path, value, DebugLogger{this}, [this]() { return get_root(); });
    }

    bool remove_path(RBPath& path)
    {
      return Policy::remove_path(path, DebugLogger{this}, [this]() { return get_root(); });
    }
  };
} // namespace snmalloc
